...
let peli = await (await fetch('https://i.postimg.cc/nrV53nXd/c25039b25180c751becbe6d84c155eb0.jpg')).buffer()
let ye = await (await fetch('https://i.postimg.cc/nrV53nXd/c25039b25180c751becbe6d84c155eb0.jpg')).buffer()
  let _return
  let _syntax = ''
